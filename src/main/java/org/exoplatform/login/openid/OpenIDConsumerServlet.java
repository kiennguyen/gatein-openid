...
public class OpenIDConsumerServlet extends javax.servlet.http.HttpServlet {
   ...
   private String openid_portlet_url;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if ("true".equals(req.getParameter("is_return"))) {
			...
			this.openid_identifier = req.getParameter("openid_identifier");
			this.openid_portlet_url = req.getParameter("openid_portlet_url");
		   ...
		   String returnToUrl = httpReq.getRequestURL().toString() + "?is_return=true";
			...
			if ("1".equals(httpReq.getParameter("fullname"))) {
				fetch.addAttribute("fullname",
						"http://schema.openid.net/contact/fullname", true);
